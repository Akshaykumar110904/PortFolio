...
export const NavBar = ({menuOpen,setMenuOpen}) => {
    ...
    return (
        <nav className="fixed top-0 w-full z-40 bg-[rgba(10,10,10,0.8)] backdrop-blur-sm border-b border-white/10 shadow-1g"> 
            <div className="max-w-6xl mx-auto px-4">
                <div className="flex px-70 py-10 justify-between items-center h-16">
                    {/* {" "}<a href="#home" className="text-4xl text-white opacity-45 font-mono font-semibold">Ravulakari Akshay Kumar</a>{" "} */}
                    <div className="left-1/2 -translate-x-11/12 w-7 h-5 relative cursor-pointer z-40 md:hidden" onClick={() => setMenuOpen(!menuOpen)}>
                        &#9776;
                    </div>
